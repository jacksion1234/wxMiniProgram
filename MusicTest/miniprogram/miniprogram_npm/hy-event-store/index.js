...
__DEFINE__(1650980255290, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1650980255291,"./event-store":1650980255292}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1650980255291, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1650980255292, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1650980255291,"./utils":1650980255293}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1650980255293, function(require, module, exports) {
...
return __REQUIRE__(1650980255290);
})()
